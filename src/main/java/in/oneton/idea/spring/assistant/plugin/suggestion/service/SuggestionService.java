...
public interface SuggestionService {
    ...
    static SuggestionService getInstance(@NotNull final Module module) {
    ...
    default boolean cannotProvideSuggestions() {
        return !this.canProvideSuggestions();
    }
     ...
     */
    @Nullable
    List<LookupElement> findSuggestionsForQueryPrefix(FileType fileType,
                                                      PsiElement element,
